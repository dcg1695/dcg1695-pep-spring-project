...
@Service
public class MessageServiceTool implements MessageService {
    ...
    public Message updateMessage(Integer id, Message message){
        ...
        if (messageRepository.existsById(id)){
            ...
            // If the message text exceeds 255 characters...
            if (message.getMessageText().length() > 255){
                throw new IllegalArgumentException("Message text exceeds the allowable limit.");
            }

            // If the checks pass, update and save the message
            Optional<Message> optionalMessage = messageRepository.findById(id);
    ...
    public Message createMessage(Message message){
        ...
        // If the checks pass, create the message
        return messageRepository.save(message);
    }
